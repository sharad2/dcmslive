 ...
 *  $Revision: 5656 $
 *  $Author: skumar $
 *  $HeadURL: http://server/svn/dcmslive/Projects/DcmsLive/trunk/Web/Reports/Category_040/R40_24.aspx $
 *  $Id: R40_24.aspx 5656 2013-07-15 13:48:49Z skumar $
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <meta name="Version" content="$Id: R40_24.aspx 5656 2013-07-15 13:48:49Z skumar $" />
    ...
    <jquery:Tabs ID="tabs" runat="server">
        <jquery:JPanel ID="jp" runat="server" HeaderText="Filters">
            <eclipse:TwoColumnPanel ID="tcpFilters" runat="server">
                ...
                <eclipse:LeftLabel ID="LeftLabel8" runat="server" Text="Building" />
             <%--   <d:BuildingSelector runat="server" ID="ctlWarehouseLocation" ShowAll="false" ConnectionString="<%$ ConnectionStrings:DCMSLIVE %>"
                ...
                <eclipse:LeftPanel ID="LeftPanel1" runat="server">
                    <eclipse:LeftLabel ID="LeftLabel9" runat="server"  Text="Check For All Building"/>
                    <i:CheckBoxEx ID="cbAllBuilding" runat="server" OnClientChange="cbAllBuilding_OnClientChange" checked="true" FriendlyName="All Buildings">
                        <Validators>
