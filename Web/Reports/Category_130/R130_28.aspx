<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" Title="SKUs In Shortage And Pullback Quantity" %>
 ...
 *  $Revision: 5856 $
 *  $Author: sbist $
 *  $HeadURL: http://server/svn/dcmslive/Projects/DcmsLive/trunk/Web/Reports/Category_130/R130_28.aspx $
 *  $Id: R130_28.aspx 5856 2013-08-03 04:59:07Z sbist $
...
select cust.customer_id as customer_id, 
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        if (string.IsNullOrEmpty(ddlQualityCode.Value))
        {
            const string QUERY = @"SELECT T.QUALITY_CODE as quality_code FROM TAB_QUALITY_CODE T WHERE T.ORDER_QUALITY = 'Y'";
            OracleDataSource ds = new OracleDataSource(ConfigurationManager.ConnectionStrings["dcmslive"]);
            ds.SysContext.ModuleName = "GetQuality";
            ds.SelectSql = QUERY;
            var quality = ds.Select(DataSourceSelectArguments.Empty).Cast<object>()
                  .Select(p => Convert.ToString(DataBinder.Eval(p, "quality_code"))).First();
            if (quality != null)
            {
                ddlQualityCode.Value = quality; 
            }
        }
        base.OnLoad(e);
    }
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <meta name="ChangeLog" content="Start date and Cancel Date filters are avaliable now." />
    <meta name="Version" content="$Id: R130_28.aspx 5856 2013-08-03 04:59:07Z sbist $" />
...
ALL_INVENTORY_SKU AS
 ...
 SELECT  IL.IA_ID AS INVENTORY_AREA,
         NVL(IL.SHORT_NAME,IL.IA_ID) as area_name,
         IL.sku_id,
         IL.VWH_ID AS VWH_ID,
